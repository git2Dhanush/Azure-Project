# spotify_assest_bundle_azure

The 'spotify_assest_bundle_azure' project was generated by using the default-python template.

* `src/`: Python source code for this project.
  * `src/spotify_assest_bundle_azure/`: Shared Python code that can be used by jobs and pipelines.
...
2. To deploy a development copy of this project, type:
    ...
    `[dev yourname] spotify_assest_bundle_azure_etl` to your workspace.
